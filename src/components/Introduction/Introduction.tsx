            ...
            <div className="w-full h-full bg-gradient-to-r via-black/30 to-black/10">
                <div className="container grid items-center h-full px-2 mx-auto md:grid-cols-2 md:text-left">
                    <motion.div className="hidden w-auto h-auto mx-auto md:block"
                        ...
                        exit="hidden"
                    >
                        <Image src={Home} priority width="700" height="450" alt="Avatar" />
                    </motion.div>
                    <motion.div variants={fadeIn("left", 0.5)}
                        ...
                        exit="hidden"
                    >
                        <h2 className="mb-5 text-4xl leading-tight md:mb-10 text-white">Hola soy Damian, <br />
                            <span className='text-amber-500'>Juntos haremos tus proyectos realidad.</span>
                        </h2>
